...
INSERT INTO `doctrine_migration_versions` (`version`, `executed_at`, `execution_time`) VALUES
	('DoctrineMigrations\\Version20230213100517', '2023-02-13 10:05:49', 101);
...
-- Listage des données de la table symfonyuser.user : ~1 rows (environ)
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` (`id`, `email`, `pseudo`, `roles`, `password`, `is_verified`) VALUES
	(1, 'mhd@gmail.com', 'mhd', '[]', '$2y$13$9HqK8aEklX7CPOd0LJxZC.Q/lO1GlH9LCDESwDcdwaAOrBVAD13Xa', 0);
